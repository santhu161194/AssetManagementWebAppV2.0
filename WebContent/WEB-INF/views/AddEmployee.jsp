...
<script type="text/javascript">
	function onSubmit() {
...

		{
			...
			document.getElementById("pass_error").innerHTML = "password should not exceed 40";
...

		{
			...
			document.getElementById("pass_error").innerHTML = "password should be greater than 5";
